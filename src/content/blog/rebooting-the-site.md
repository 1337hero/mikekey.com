...
date: 2014-09-28
heroImage: '../../assets/images/blog/hero-rebooting-the-site.jpg'
---
...
* ~~Roll ubuntu 14.04 server with LEMP~~* ~~Migrate from WordPress to Jeykll~~
* ~~Move blog comments to Disqus~~* ~~Deploy repo of site on Github~~
* ~~Deploy Cloudflare CDN~~* ~~301 Redirect MikeKey.com to mk3y.com~~
* Redesign Website for 2015* Rewrite About Page
* Set regular blogging goals (2 posts per month)* Learn new skills
